...
export const FacilityLeftLowerContent = styled.div`
  ...
  width: 100%;
`
export const PendingApplicationsOuterWrapper = styled.div`
  display: flex;
...
export const PendingAppicationsInnerWrapper = styled.div`
  display: flex;
  flex-direction: column;
  align-items: start;
  gap: 18px;
...
export const PendingApplicationsDetailsWrapper = styled.div`
  display: flex;
  padding: 10px 0px;
  flex-direction: column;
  align-items: flex-start;
